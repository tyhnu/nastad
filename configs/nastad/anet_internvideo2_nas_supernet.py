...
post_processing = dict(
    nms=dict(use_soft_nms=True, sigma=0.75, max_seg_num=100, min_score=0.001, multiclass=False, voting_thresh=0.9),
    external_cls=dict(type="StandardClassifier", path="/data/activitynet-1.3/classifiers/anet_UMTv2_6B_k710+K40_f16_frozenTuning.json_converted.json", topk=2),
    save_dict=False,
)
